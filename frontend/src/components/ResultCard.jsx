...
import { BsCheckCircleFill, BsClipboard, BsClipboardCheck, BsSendFill } from 'react-icons/bs';
import { MdAutoAwesome, MdLocationOn } from 'react-icons/md';

export default function ResultCard({ result, forwarded, submitting, submitError, onSubmit }) {
    ...
    >
      ...
      >
        ...
        <button
          ...
          style={{
            ...
            borderRadius: '8px', padding: '9px 15px', cursor: 'pointer',
      ...
      {forwarded ? (
        <div style={{
          ...
          <span>✅</span>
          <span>Sent to Stage 2 for semantic clustering — check the Dashboard.</span>
        </div>
      ) : (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          >
            <BsSendFill /> {submitting ? 'Submitting…' : 'Submit'}
          </button>
        </div>
      )}
    </motion.div>
